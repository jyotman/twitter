...
describe('Message Splitting', () => {
    ...
    test('More than 50 characters and less than 100 characters', () => {
        const result = util.splitMessage(`I can't believe Tweeter now supports chunking my messages, 
    ...
    test('More than 100 characters and less than 150 characters', () => {
        const result = util.splitMessage(`I can't believe Tweeter now supports chunking my messages, 
        so I don't have to do it myself. It is a very useful feature.`);
    ...
    test('Word with 51 characters', () => {
        expect(util.splitMessage(`adnsandskndaskdnasndkasndkasndkasndkasndkasndkasndk`))
            .toThrow('Word adnsandskndaskdnasndkasndkasndkasndkasndkasndkasndk is too long');
    });

    test('Word with 47 characters in a sentence', () => {
        expect(util.splitMessage(`I love adnsandskndaskdnasndkasndkasndkasndkasndkasndka`))
            .toThrow('Word adnsandskndaskdnasndkasndkasndkasndkasndkasndka is too long');
    });

    test('Word with 46 characters in a sentence', () => {
        const result = util.splitMessage(`I love adnsandskndaskdnasndkasndkasndkasndkasndkasndka`);
        expect(result).toHaveLength(2);
        expect(result[0]).toBe(`1/2 I love`);
        expect(result[1]).toBe(`2/2 adnsandskndaskdnasndkasndkasndkasndkasndkasndka`);
    });
});